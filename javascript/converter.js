...
// Navbar unit converter calculator button
document.getElementById('converterBtn').addEventListener('click', displayConvertCalc);
...
<div class="container converter-wrapper">
  <div class="row">
    <div class="col-md-8 mx-auto stencil-text">
      <div class="card card-body text-center mt-5 shadow-lg bg-silver">
        <h1 class="shimmer">Unit Converter</h1>

        <form name="property_form">
          <span class="border border-secondary">
            <select class="selector select-property  text-secondary" name="the_menu" size=1 onChange="UpdateUnitMenu(this, document.form_A.unit_menu); UpdateUnitMenu(this, document.form_B.unit_menu)">
            </select>
          </span>
        </form>
        ...
        <div class="converter-side-a">
          <form name="form_A" onSubmit="return false">
            <input type="text" class="inputs numbersonly text-secondary" name="unit_input" maxlength="20" value="0" onKeyUp="CalculateUnit(document.form_A, document.form_B)">
            <span class="border border-secondary">
              <select class="selector text-secondary" name="unit_menu" onChange="CalculateUnit(document.form_B, document.form_A)">
              </select>
            </span>
          </form>
        </div>

        <div class="converter-equals text-secondary">
          <img class="arrows-lightMode" id="equalSign" src="images/arrows.png" alt="two arrows forming an equal sign" width="50">
        </div>

        <div class="converter-side-b">
          <form name="form_B" onSubmit="return false">
            <input type="text" class="inputs numbersonly text-secondary" name="unit_input" maxlength="20" value="0" onkeyup="CalculateUnit(document.form_B, document.form_A)">
            <span class="border border-secondary">
              <select class="selector text-secondary" name="unit_menu" onChange="CalculateUnit(document.form_A, document.form_B)">
              </select>
            </span>
          </form>
        </div>
...
function CalculateUnit(sourceForm, targetForm) {
  // Wrapper function to validate input before making the conversion
...
function ConvertFromTo(sourceForm, targetForm) {
  ...
  // Check which property we are working in
  propIndex = document.property_form.the_menu.selectedIndex;

  // Determine what unit to convert from
  sourceIndex = sourceForm.unit_menu.selectedIndex;
  sourceFactor = factor[propIndex][sourceIndex];

  // Determine what unit to convert to
...
// Restrict textboxes to accept numbers only
document.querySelector('.numbersonly').addEventListener('keydown', function(e) {
