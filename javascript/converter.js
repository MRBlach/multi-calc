...
<form name="property_form">
  <span class="border border-secondary">
    <select class="select-property  text-secondary" name="the_menu" size=1 onChange="UpdateUnitMenu(this, document.form_A.unit_menu); UpdateUnitMenu(this, document.form_B.unit_menu)">
    </select>
  </span>
</form>
...
<div class="converter-side-a">
  <form name="form_A" onSubmit="return false">
    <input type="text" class="numbersonly text-secondary" name="unit_input" maxlength="20" value="0" onKeyUp="CalculateUnit(document.form_A, document.form_B)">
    <span class="border border-secondary">
      <select class="text-secondary" name="unit_menu" onChange="CalculateUnit(document.form_B, document.form_A)">
      </select>
    </span>
  </form>
...
<div class="converter-equals text-secondary">
 <img id="equalSign" src="images/arrows.png" alt="two arrows forming an equal sign" width="50">
</div> <!-- /converter-side-a -->

<div class="converter-side-b">
  <form name="form_B" onSubmit="return false">
    <input type="text" class="numbersonly text-secondary" name="unit_input" maxlength="20" value="0" onkeyup="CalculateUnit(document.form_B, document.form_A)">
    <span class="border border-secondary">
      <select class="text-secondary" name="unit_menu" onChange="CalculateUnit(document.form_A, document.form_B)">
      </select>
    </span>
  </form>
